...
<template>
  <div class="columns my-4">
    <div class="column is-4 is-offset-4 has-background-white">
      <header class="main-header block pt-5 px-4">
        <hgroup class="mb-3">
          <h1>
      ...
      <form method="POST" @submit.prevent="$submitForm">
        ...
        <section id="amount" class="block px-4">
          <div class="columns">
            ...
            <div class="column">
              <div class="field is-stacked">
                <p class="control">
                  <button class="button is-fullwidth" type="button" v-on:click="amount = 3">
                    £3
                  </button>
                </p><p class="control">
                  <button class="button is-fullwidth" type="button" v-on:click="amount = 5">
                    £5
                  </button>
                </p><p class="control">
                  <button class="button is-fullwidth" type="button" v-on:click="amount = 10">
                    £10
                  </button>
                </p>
              </div>
        ...
        <section id="account-data" class="block px-4">
          <header class="mb-3">
        ...
        <section id="payment" class="block px-4">
          <header class="mb-3">
        ...
        <section class="block px-4">
          <p><input class="button wrap-text is-dark is-fullwidth" type="submit" :value="submitText"></p>
      ...
      <footer id="footer" class="block pb-5 px-4 mt-4">
        <p>
